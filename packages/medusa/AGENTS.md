...
Kanon faktów dla agentów specyficznych dla pakietu `medusa`. Fakty ogólnomonorepowe
...
> Komendy zarządzania zależnościami (`uv sync`, `uv add`, `uv venv`) są workspace-wide — patrz root `../../AGENTS.md`.
