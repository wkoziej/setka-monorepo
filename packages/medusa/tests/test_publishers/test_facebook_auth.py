...
class TestFacebookAuth:
    ...
    def test_init_missing_required_fields(self):
        ...
        incomplete_configs = [
            ...
            {"page_id": "123", "access_token": "token", "app_id": "app"},  # Missing app_secret
        ]
    ...
    def test_init_invalid_field_types(self):
        ...
        invalid_configs = [
            {"page_id": 123, "access_token": "token", "app_id": "app", "app_secret": "secret"},
            {"page_id": "123", "access_token": None, "app_id": "app", "app_secret": "secret"},
            {"page_id": "123", "access_token": "token", "app_id": [], "app_secret": "secret"},
        ]
    ...
    def test_check_permissions_custom_required(self, facebook_auth, mock_requests_get):
        ...
        mock_response.json.return_value = {
            "data": [
                {"permission": "custom_permission", "status": "granted"}
            ]
        }
        mock_requests_get.return_value = mock_response
        
        result = facebook_auth.check_permissions(required_permissions=["custom_permission"])
        assert result is True
    ...
    def test_api_url_construction(self, facebook_auth):
        ...
        assert url == "https://graph.facebook.com/v19.0/me?access_token=valid_token_12345"
