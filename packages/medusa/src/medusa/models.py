...
class TaskResult:
    ...
    def update_status(
        self, new_status: TaskStatus, message: Optional[str] = None
    ) -> None:
        """
...
class MediaMetadata:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "scheduled_publish_time": self.scheduled_publish_time.isoformat()
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "MediaMetadata":
        ...
        if data.get("scheduled_publish_time"):
            scheduled_publish_time = datetime.fromisoformat(
                data["scheduled_publish_time"].replace("Z", "+00:00")
            )
