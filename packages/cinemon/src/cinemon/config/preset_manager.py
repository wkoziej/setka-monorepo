...
class PresetManager:
    ...
    def __init__(self):
        ...
        self.preset_dir = Path(__file__).parent.parent.parent.parent / "blender_addon" / "example_presets"
    ...
    def _load_preset_template(self, yaml_file: Path) -> BlenderYAMLConfig:
        ...
        from setka_common.config.yaml_config import (
            ProjectConfig, AudioAnalysisConfig, LayoutConfig, Resolution
        )
        ...
        layout = LayoutConfig(
            type=layout_data.get("type", "random"),
